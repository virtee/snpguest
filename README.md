...
snpguest --help
```
Apart from `help`, there are 6 other subcommands for `snpguest` that have been listed below with their purpose.
...
Command to Requests certificates.
...
1. `ca`
    ...
    - `$PROCESSOR_MODEL` : Specifies the host processor model (Milan or Genoa). 
